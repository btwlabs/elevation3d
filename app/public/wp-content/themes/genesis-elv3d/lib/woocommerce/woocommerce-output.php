 ...
 * Genesis ELV3D.
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the Genesis ELV3D Theme.
 *
...
add_filter( 'woocommerce_enqueue_styles', 'genesis_elv3d_woocommerce_styles' );
/**
 ...
 */
function genesis_elv3d_woocommerce_styles( $enqueue_styles ) {

	$enqueue_styles[ genesis_get_theme_handle() . '-woocommerce-styles' ] = [
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/genesis-elv3d-woocommerce.css',
		'deps'    => '',
...
add_action( 'wp_enqueue_scripts', 'genesis_elv3d_woocommerce_css' );
/**
 ...
 */
function genesis_elv3d_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'genesis_elv3d_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'genesis_elv3d_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		genesis_elv3d_color_contrast( $color_accent )
	) : '';
