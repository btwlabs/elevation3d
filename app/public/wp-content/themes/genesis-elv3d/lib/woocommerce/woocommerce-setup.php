 ...
 * Genesis ELV3D.
 *
 * This file adds the required WooCommerce setup functions to the Genesis ELV3D Theme.
 *
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'genesis_elv3d_woocommerce_breakpoint' );
/**
 ...
 */
function genesis_elv3d_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'genesis_elv3d_default_products_per_page' );
/**
 ...
 */
function genesis_elv3d_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'genesis_elv3d_woocommerce_pagination' );
/**
 ...
 */
function genesis_elv3d_woocommerce_pagination( $args ) {

	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'genesis-elv3d' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'genesis-elv3d' ) );

	return $args;

}

add_action( 'after_switch_theme', 'genesis_elv3d_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function genesis_elv3d_woocommerce_image_dimensions_after_theme_setup() {
	...
	genesis_elv3d_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'genesis_elv3d_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function genesis_elv3d_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function genesis_elv3d_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'genesis_elv3d_gallery_image_thumbnail' );
/**
 ...
 */
function genesis_elv3d_gallery_image_thumbnail( $size ) {
