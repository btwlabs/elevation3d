 ...
 * Genesis ELV3D.
 *
 * This file adds the required CSS to the front end to the Genesis ELV3D Theme.
 *
...
add_action( 'wp_enqueue_scripts', 'genesis_elv3d_css' );
/**
...
function genesis_elv3d_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'genesis_elv3d_logo_width', 350 );
