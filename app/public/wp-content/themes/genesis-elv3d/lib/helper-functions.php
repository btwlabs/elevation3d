 ...
 * Genesis ELV3D.
 *
 * This file adds the required helper functions used in the Genesis ELV3D Theme.
 *
 ...
 */
function genesis_elv3d_color_contrast( $color ) {
 ...
 */
function genesis_elv3d_color_brightness( $color, $change ) {
